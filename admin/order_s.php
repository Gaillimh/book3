	    ...
	    if($_POST['show_find']!="")
		 {
		  ...
		  if($username=="")
		   {
		       $sql=mysqli_query($conn,"select * from orders where orderid='".$ddh."'");
		   }
		  elseif($ddh=="")
		  {
		      $sql=mysqli_query($conn,"select * from orders where xiadanren='".$username."'");
		   }
		  else
		  {
		      $sql=mysqli_query("$conn,select * from orders where xiadanren='".$username."'and orderid='".$ddh."'");
		  }
