            ...
            <tr>
			  ...
			  <table width="700" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
			   <script language="javascript">
				...
				<tr>
                  <td height="25"><div align="center">开始时间:<input name="s" onFocus="show_cele_date(s,'','',s)" type="text"  size="10"  value='2012-1-1'>结束时间:<input name="e" onFocus="show_cele_date(e,'','',e)" type="text"  size="10"  value='2012-4-31' class="inputcss">  <input type="hidden" value="show_find" name="show_find">
